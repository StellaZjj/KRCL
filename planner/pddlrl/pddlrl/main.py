...
default_gin_file = os.path.join(os.path.dirname(__file__), "depots.gin")
# print('************* default_gin_file ****************')
# print(default_gin_file)
...
def select_hyper(require_unique=False):
    for _ in range(1):
        ...
        # print('*************** train_dir ****************')
        # print(str(json.dumps(hyper,sort_keys=True)))
        # print(hash)
        # print(train_dir)
        '''
...
def train_RL_aux():
    ...
    hyper["experiment_loop.num_steps"] = 32000
