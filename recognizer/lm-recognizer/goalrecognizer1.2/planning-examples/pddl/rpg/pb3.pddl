...
(define (problem pb3)
    (:domain RPG)
    (:objects
        room0_0 room0_1 room0_2 room0_3 room1_0 room1_1 room1_2 room1_3 room2_0 room2_1 room2_2 room2_3 room3_0 room3_1 room3_2 room3_3 room4_0 room4_1 room4_2 room4_3 trap_1_0 trap_0_1 trap_3_1 trap_4_1 trap_2_2 trap_0_3 sword_4_0 sword_2_1 sword_0_2 sword_2_3 monster_2_0 monster_3_0 monster_1_1 monster_1_2 monster_3_2 monster_1_3 monster_3_3 empty
    )
    (:init
        (at room4_3)
        ...
        (in room4_0 sword_4_0)
        (in room2_1 sword_2_1)
        (in room0_2 sword_0_2)
        (in room2_3 sword_2_3)
        (sword sword_4_0)
        (sword sword_2_1)
        (sword sword_0_2)
        (sword sword_2_3)

        (in room2_0 monster_2_0)
        (in room3_0 monster_3_0)
        (in room1_1 monster_1_1)
        (in room1_2 monster_1_2)
        (in room3_2 monster_3_2)
        (in room1_3 monster_1_3)
        (in room3_3 monster_3_3)
